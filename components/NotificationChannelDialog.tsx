...
const SESSION_DISMISS_KEY = 'turnaicashNotificationPromptSessionDismiss';
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end justify-center bg-black/60 px-4 py-6 backdrop-blur-sm sm:items-center">
      <div className="max-h-[92vh] w-full max-w-lg overflow-y-auto rounded-3xl bg-white shadow-2xl dark:bg-slate-900">
        <div className="bg-gradient-to-br from-primary to-primary/70 px-6 pb-6 pt-6 text-primary-foreground">
          <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-white/15">
            <Bell className="h-6 w-6" />
          </div>
          <h2 className="text-xl font-bold">Activez vos alertes Turnaicash</h2>
